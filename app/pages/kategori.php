...
<?php list( , $category) = explode('-', $_GET['page']); ?>
<?php $data = $wisata->getWhere(['kategori' => $category]); ?>
        ...
        <div class="col">
            <div class="card shadow mb-4">
                ...
                <div
                    ...
                    <h6 class="m-0 font-weight-bold text-primary"><?= $title = ucwords(str_replace('-', ' ', $_GET['page'])) ?></h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                    <div class="row">
                        ...
                        <?php else: ?>
                            <div class="col text-center">
                                <p class="">Tidak ada tempat wisata di kategori ini.</p>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
